...
//            out.println("<body>");
            ...
            if (checked==null) {
                ...
                //setting users value into the entity class
                Users user = new Users(name, pass, email, gender, about);
                
                //inserting the values to db using dao class
                
                UserDao udao = new UserDao(ConnectionProvider.createConnection());
                
                if (udao.addUsers(user)) {
                    out.println("you have successfully registered here");
                }
                else{
